      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 min-h-[88svh] py-20 md:py-24 lg:py-28 flex items-center">
        <div className="w-full max-w-5xl mx-auto text-center px-6 md:px-10 lg:px-14">
          ...
          >
            ...
            <h1 className="hero-metal-text hero-metal-text-mobile mx-auto mt-6 max-w-[12ch] text-center text-3xl sm:max-w-none sm:text-6xl md:text-7xl lg:text-[5.6rem] leading-[1.06] drop-shadow-[0_3px_12px_rgba(0,0,0,0.28)] sm:drop-shadow-[0_4px_22px_rgba(0,0,0,0.45)]">
